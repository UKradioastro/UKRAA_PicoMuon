...
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/data/processed/adc/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/data/processed/cpm/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/data/processed/day/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/data/processed/month/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/data/processed/week/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/data/raw/ACM0
sudo -u pi mkdir -v  $HOME/UKRAA_PicoMuon/logfiles
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/3month/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/adc/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/cpm/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/day/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/freq/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/month/ACM0
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/plots/week/ACM0
sudo -u pi mkdir -v  $HOME/UKRAA_PicoMuon/temp
sudo -u pi mkdir -vp $HOME/UKRAA_PicoMuon/WWW/temp
...
cp -vf $HOME/UKRAA_PicoMuon/install/PicoMuonACM0.service /etc/systemd/system
...
crontab -u root -l  | cat - $HOME/UKRAA_PicoMuon/install/crontab-PicoMuonACM0-entry.cron | crontab -u root -
...
cp -v $HOME/UKRAA_PicoMuon/WWW/index.html /var/www/html/index.html
cp -vr $HOME/UKRAA_PicoMuon/WWW/images /var/www/html/
cp -vr $HOME/UKRAA_PicoMuon/WWW/temp /var/www/html/
echo "Files moved to /var/www/html"


echo "Start installing webpage update crontab entry..."
crontab -u root -l | cat - $HOME/UKRAA_PicoMuon/install/crontab-webpage-update-entry.cron | crontab -u root -
echo "webpage update crontab entry installed"


echo "Final cleanup..."
sudo -u pi rm -vrf $HOME/UKRAA_PicoMuon/images
sudo -u pi rm -vrf $HOME/UKRAA_PicoMuon/WWW
sudo -u pi rm -vrf $HOME/UKRAA_PicoMuon/update
sudo -u pi rm -v $HOME/UKRAA_PicoMuon/README.md
...
exec rm -vrf $HOME/UKRAA_PicoMuon/install
