...
print "PlotData90DaysACM0.gp       : "\
    ...
    ." : Started ACM0 90 days % deviation plot from "\
...
# 90 days data
pathPlot3 = "$HOME/UKRAA_PicoMuon/plots/3month/ACM0/".date."_90_days_plot.png"
...
plot FileData using 1:(((($4/MUON_mean)*100)-100)) linetype 1 linewidth 1 linecolor rgb "dark-violet" notitle "1-day averages of muons detected" with lines, \
...
pathPlot = "$HOME/UKRAA_PicoMuon/temp/ACM0_90_days_plot"
...
print "PlotData90DaysACM0.gp       : "\
    .system("date +'%Y-%m-%d %H:%M:%S'")\
    ." : Completed ACM0 90 days % deviation day plot from "\
    .system("date -d '90 days ago' +'%Y-%m-%d'")\
    ." to "\
    .system("date -d yesterday +'%Y-%m-%d'")
