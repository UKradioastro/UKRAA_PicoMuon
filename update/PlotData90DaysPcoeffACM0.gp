...
# Set up data paths
pathData        = "$HOME/UKRAA_PicoMuon/data/processed/3month/ACM0"
...
pathPlot3 = "$HOME/UKRAA_PicoMuon/plots/3month/ACM0/".date."_90_days_pressure_coefficient_plot.png"
...
# least square fit
set print "$HOME/UKRAA_PicoMuon/data/environment/coefficient/".date."_90_days_pressure_coefficient.txt"            # Define a filename to save the values
c = 0
f(x) = a0*x + c
set fit nolog quiet
#set fit logfile "$HOME/UKRAA_PicoMuon/data/environment/coefficient/".date."_pressure_coefficient.txt" quiet
...
pathPlot = "$HOME/UKRAA_PicoMuon/temp/ACM0_90_days_pressure_coefficient_plot"
