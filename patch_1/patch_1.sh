...
echo "Start patch#1 UKRAA PicoMuon..."
...
if [ -r /home/pi/UKRAA_PicoMuon/data/NMDB/neutrons/2025/2025-07/2025-07-26.txt ]; then
    su pi -c "mv -f /home/pi/UKRAA_PicoMuon/data/NMDB/neutrons/2025/2025-07/2025-07-26.txt /home/pi/UKRAA_PicoMuon/data/NMDB/neutrons/2025/2025-07/2025-07-26_old.txt"
fi

# copy correct NMDB data to folder
echo "Moving correct NMDB data to /home/pi/UKRAA_PicoMuon/data/NMDB/neutrons/2025/2025-07/..."
sudo -u pi cp -v /home/pi/UKRAA_PicoMuon/Patch#1/2025-07-26.txt /home/pi/UKRAA_PicoMuon/data/NMDB/neutrons/2025/2025-07/2025-07-26.txt
...
if [ -r /home/pi/UKRAA_PicoMuon/data/processed/day/ACM0/2025/2025-07/2025-07-26.txt ]; then
    su pi -c "mv -f /home/pi/UKRAA_PicoMuon/data/processed/day/ACM0/2025/2025-07/2025-07-26.txt /home/pi/UKRAA_PicoMuon/data/processed/day/ACM0/2025/2025-07/2025-07-26.txt"
fi
...
echo "Completed patch#1 UKRAA PicoMuon."
echo "Your week/month plots should be correct when data is processed for tomorrow."
sleep 10


# if successful
echo "Removing patch#1 directory and exiting..."
exec rm -vrf /home/pi/UKRAA_PicoMuon/Patch#1
