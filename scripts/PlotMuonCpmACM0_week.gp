...
# muons detected
pathPlot3 = "/home/pi/UKRAA_muons/plots/cpm/ACM0/".date."_CPM_M_plot_week.png"
...
# Title for graph
# muons detected
GraphTitle3 = "Muon cpm data from ".system("date -d '7 days ago' +'%A %d %B %Y'")." to ".system("date -d yesterday +'%A %d %B %Y'")."\n Graph is updated every day at 9.30am \n"
...
# Path to directory to store file
pathPlot = "/home/pi/UKRAA_muons/temp/ACM0_C-Cpm_week"
