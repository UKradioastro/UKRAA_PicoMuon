...
ThreeMonthPath = '/home/$USER/UKRAA_PicoMuon/data/processed/3month/ACM0/' \
...
ThreeMonthDataFile = '/home/$USER/UKRAA_PicoMuon/data/processed/3month/ACM0/' \
               + dt.datetime.strftime(dt.datetime.now() - dt.timedelta(1), '%Y') \
               + "/" \
               + dt.datetime.strftime(dt.datetime.now() - dt.timedelta(1), '%Y-%m') \
               + "/temp.txt"
...
# Processed data path
ProcessedPath = '/home/$USER/UKRAA_PicoMuon/data/processed/3month/ACM0/'\
                + dt.datetime.strftime(dt.datetime.now() - dt.timedelta(1), '%Y') \
                + "/" \
                + dt.datetime.strftime(dt.datetime.now() - dt.timedelta(1), '%Y-%m')
...
ProcessedDataFile = "/home/$USER/UKRAA_PicoMuon/data/processed/3month/ACM0/" \
                     + dt.datetime.strftime(dt.datetime.now() - dt.timedelta(1), '%Y') \
                     + "/" \
                     + dt.datetime.strftime(dt.datetime.now() - dt.timedelta(1), '%Y-%m') \
                     + "/" \
